...
def spin_container(
    ...
    command = [
        ...
        "-e", f"SPELLER_C_FILENAME={SPELLER_C_FILENAME}",
        "-e", f"DICTIONARY_H_FILENAME={DICTIONARY_H_FILENAME}",
        "-e", f"DICTIONARY_C_BENCHMARK_FILENAME={DICTIONARY_C_BENCHMARK_FILENAME}",
        "-e", f"BENCHMARK_EXECUTABLE={BENCHMARK_EXECUTABLE}",
        "--network", "none",
